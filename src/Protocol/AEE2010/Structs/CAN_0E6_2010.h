...
// CANID: 0E6
const uint16_t CAN_ID_0E6_2010 = 0x0E6;
const uint8_t CAN_ID_0E6_2010_LEN = 5;

// Read right to left in documentation
union CAN_0E6_2010_Byte1Struct {
    struct {
...
// Read right to left in documentation
union CAN_0E6_2010_Byte7Struct {
    struct {
...
// Read right to left in documentation
union CAN_0E6_2010_Byte23Struct {
    struct {
...
struct Can0E6_2010Struct {
    CAN_0E6_2010_Byte1Struct  Byte1;
    CAN_0E6_2010_Byte23Struct RearLeftWheel;
    CAN_0E6_2010_Byte23Struct RearRightWheel;
    uint8_t BrakeCpuBatteryVoltage;
    CAN_0E6_2010_Byte7Struct Byte7;
    uint8_t Checksum;
};

union Can0E6_2010Packet {
    Can0E6_2010Struct data;
    uint8_t Can0E6Packet[sizeof(Can0E6_2010Struct)];
};
#endif
