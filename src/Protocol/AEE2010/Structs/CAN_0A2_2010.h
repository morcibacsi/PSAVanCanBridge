...
#ifndef _CAN_0A2_2010_h
    #define _CAN_0A2_2010_h

#include <stdint.h>

const uint16_t CAN_0A2_2010_INTERVAL = 100;
const uint16_t CAN_ID_0A2_2010 = 0x0A2;

union CAN_0A2_2010_Byte2Struct {
    struct {
...
union CAN_0A2_2010_Byte3Struct {
    struct {
        uint8_t                   : 7; // bit 0-6
...
union CAN_0A2_2010_Byte5Struct {
    struct {
...
struct CAN_0A2_2010Struct {
    uint8_t NavMenuScroll;
    CAN_0A2_2010_Byte2Struct NavMenuCommands;
