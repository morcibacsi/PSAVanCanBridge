...
const uint16_t CAN_10B_INTERVAL_2010 = 100;

// CANID: 10B
const uint16_t CAN_ID_DASH1_2010 = 0x10B;

const uint8_t CAN_ROTATE_COUNTER_CLOCKWISE_2010 = 0;
const uint8_t CAN_ROTATE_CLOCKWISE_2010 = 1;

// Read right to left in documentation
union CAN_10B_2010_Byte4Struct {
    struct {
...
union CAN_10B_2010_Byte7Struct {
    struct {
