...
const int VAN_POPUP_MSG_HEADLIGHT_BEND_SYSTEM_FAULT            = 0X39; // On RT3 monochrome: Rear LH passenger seatbelt unfastened
const int VAN_POPUP_MSG_HEADLIGHT_BEND_SYSTEM_DEACTIVATED      = 0X3A; // On RT3 monochrome: Rear RH passenger seatbelt unfastened
const int VAN_POPUP_MSG_HEADLIGHT_BEND_SYSTEM_ACTIVATED        = 0X3B; // On RT3 monochrome: Front passenger seatbelt unfastened
const int VAN_POPUP_MSG_DRIVING_SCHOOL_PEDALS_INDICATION       = 0X3C;
const int VAN_POPUP_MSG_X_TYRE_PRESSURE_SENSORS_MISSING0       = 0X3D;
const int VAN_POPUP_MSG_X_TYRE_PRESSURE_SENSORS_MISSING1       = 0X3E;
const int VAN_POPUP_MSG_X_TYRE_PRESSURE_SENSORS_MISSING2       = 0X3F;
