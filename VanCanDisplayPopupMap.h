...
class VanCanDisplayPopupMap
{
    ...
    void SetPopupMessageTypeMapping()
    {
        ...
        VanToCanPopupMap[VAN_POPUP_MSG_X_TYRE_PRESSURE_SENSORS_MISSING]        = CAN_POPUP_MSG_TYRE_PRESSURES_NOT_MONITORED;
    ...
    void SetPopupMessageCategoryMapping()
    {
        ...
        VanToCanPopupCategoryMap[VAN_POPUP_MSG_X_TYRE_PRESSURE_SENSORS_MISSING]        = CAN_POPUP_MSG_SHOW_CATEGORY1;
