...
class VanCanDisplayPopupMap
{
    ...
    void SetPopupMessageTypeMapping()
    {
        ...
        VanToCanPopupMap[VAN_POPUP_MSG_HILL_HOLDER_ACTIVE]                     = CAN_POPUP_SEAT_BELTS_OF_DRIVER; // on some displays it shows HILL HOLDER ACTIVE on others it is DRIVER'S SEATBELT NOT FASTENED
