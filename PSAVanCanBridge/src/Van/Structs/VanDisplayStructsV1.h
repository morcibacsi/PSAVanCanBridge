...
#ifndef _VanDisplayStructsV1_h
    #define _VanDisplayStructsV1_h
...
//VANID: 524
const uint16_t VAN_ID_DISPLAY_POPUP_V1 = 0x524;
...
} VanDisplayMsgV1Byte12Struct;


//Read left to right in documentation
struct VanDisplayStruct {
    VanDisplayMsgV1Byte0Struct Field0;
    VanDisplayMsgV1Byte1Struct Field1;
    VanDisplayMsgV1Byte2Struct Field2;
    VanDisplayMsgV1Byte3Struct Field3;
    VanDisplayMsgV1Byte4Struct Field4;
    VanDisplayMsgV1Byte5Struct Field5;
    VanDisplayMsgV1Byte6Struct Field6;
    VanDisplayMsgV1Byte7Struct Field7;
    VanDisplayMsgV1Byte8Struct Field8;
    uint8_t Message;
    VanDisplayMsgV1Byte10Struct Field10;
    VanDisplayMsgV1Byte11Struct Field11;
    VanDisplayMsgV1Byte12Struct Field12;
    uint8_t Field13;
};

union VanDisplayPacketV1 {
    VanDisplayStruct data;
    uint8_t VanDisplayPacketV1[sizeof(VanDisplayStruct)];
};
...
class VanDisplayPacketV1Sender
{
    AbstractVanMessageSender * vanMessageSender;

public:
    VanDisplayPacketV1Sender(AbstractVanMessageSender * object)
    {
    ...
    void Send(uint8_t channelId, uint8_t messageId)
    {
        ...
        vanMessageSender->set_channel_for_transmit_message(channelId, VAN_ID_DISPLAY_POPUP_V1, serializedPacket, sizeof(packet), 0);
        memset(&packet, 0, 0);
