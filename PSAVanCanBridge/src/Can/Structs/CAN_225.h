...
const uint16_t CAN_225_INTERVAL = 500;

// CANID: 225
const uint16_t CAN_ID_225 = 0x225;
...
struct Can225Struct {
    ...
    CAN_225_Byte2Struct BandPosition;
    CAN_225_Byte3Struct Band;
    uint8_t Frequency1;
    uint8_t Frequency2;
};
#endif
